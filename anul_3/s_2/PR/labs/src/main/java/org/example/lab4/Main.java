...
public class Main {
    private static final String URL = "https://localhost:44370/api/Category/categories/";
    private static final String URL_CATEGORY = "https://localhost:44370/api/Category/";
